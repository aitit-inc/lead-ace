...
Supabase. The Free plan (1 project, 500 prospects, 5 outreach actions/day
with a 50 lifetime cap) is free in the cloud; running it yourself just
means owning the accounts and the deploy.
