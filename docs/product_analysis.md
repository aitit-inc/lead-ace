...
5. [中核テーゼ「優れるな、異なれ」+ 4 軸](#5-中核テーゼ優れるな異なれ--4-軸)
6. [誰が・なぜ払うか（本質節）](#6-誰がなぜ払うか本質節)
7. [「送受信両方提供」の優位性](#7-送受信両方提供の優位性)
8. [受信側収益モデルの Phase 整理](#8-受信側収益モデルの-phase-整理)
9. [フィードバックループの 2 軸価値](#9-フィードバックループの-2-軸価値)
10. [双方向 routing infra: 到達ビジョン](#10-双方向-routing-infra-到達ビジョン)

### Part 3: 実行計画

11. [課金プランと収益パス](#11-課金プランと収益パス)
12. [KPI](#12-kpi)
13. [タイムライン](#13-タイムライン)
14. [短期実装スプリント](#14-短期実装スプリント)

### Part 4: 棚卸し・リスク

15. [プロダクト現状](#15-プロダクト現状)
16. [リスク](#16-リスク)
